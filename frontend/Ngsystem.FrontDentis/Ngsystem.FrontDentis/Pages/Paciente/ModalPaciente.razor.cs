...
public class ModalPacienteBase: ComponentBase
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        if (objPaciente.Id != null)
        {
            ...
            else
            {
                ...
                Console.WriteLine($"No se encontró el género: {objPaciente.Genero}");
    ...
    public async Task MostrarConfirmacion()
    {
        ...
        Console.WriteLine($"fecha=>{objPaciente.FechaNacimiento}");
        ...
        if (string.IsNullOrWhiteSpace(objPaciente.TelefonoFijo)) { return; }
